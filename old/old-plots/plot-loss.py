...
def plot_loss_average(log_file, output_dir, max_epochs=30):
    ...
    plot_path = os.path.join(output_dir, "plot-loss-5.png")
...
# Paths
log_file = "/home/vellard/playlist_continuation/finetuned-model-5/checkpoint-1505/trainer_state.json"
output_dir = "/home/vellard/playlist_continuation/plot-loss"
